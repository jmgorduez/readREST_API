...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "REPO_ICON_CLASS", function() { return REPO_ICON_CLASS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "REPO_TITLE_STYLE", function() { return REPO_TITLE_STYLE; });
...
var IMG = 'img';
var P = 'p';
var REPO_ICON_CLASS = 'repo-icon';
var REPO_TITLE_STYLE = 'repo-title';
...
function createRowElement(repo) {
  var userIcon = createUserIconComponent(repo);
  var repoName = createRepoNameComponent(repo);
  var repoURL = createRepoURLComponent(repo);
  var repoCreationDate = createRepoCreationDateComponent(repo);
  var row = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["DIV"]);
...
function createUserIconComponent(repo) {
  var div = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["DIV"]);
  div.setAttribute(_constants__WEBPACK_IMPORTED_MODULE_1__["CLASS_ATTRIBUTE"], _constants__WEBPACK_IMPORTED_MODULE_1__["REPO_ICON_CLASS"]);
  var img = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["IMG"]);
...
function createRepoNameComponent(repo) {
  var div = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["DIV"]);
  div.setAttribute(_constants__WEBPACK_IMPORTED_MODULE_1__["CLASS_ATTRIBUTE"], _constants__WEBPACK_IMPORTED_MODULE_1__["REPO_TITLE_STYLE"]);
  var h1 = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["H1"]);
...
function createRepoURLComponent(repo) {
  var div = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["DIV"]);
  div.setAttribute(_constants__WEBPACK_IMPORTED_MODULE_1__["CLASS_ATTRIBUTE"], _constants__WEBPACK_IMPORTED_MODULE_1__["REPO_URL_STYLE"]);
  var p = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["P"]);
  p.textContent = "".concat(repo.url.substring(0, 50), "...");
  div.appendChild(p);
  return div;
}
...
function createRepoCreationDateComponent(repo) {
  var div = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["DIV"]);
  div.setAttribute(_constants__WEBPACK_IMPORTED_MODULE_1__["CLASS_ATTRIBUTE"], _constants__WEBPACK_IMPORTED_MODULE_1__["REPO_CREATED_AT"]);
  var p = document.createElement(_constants__WEBPACK_IMPORTED_MODULE_1__["P"]);
  p.textContent = "".concat(_constants__WEBPACK_IMPORTED_MODULE_1__["CREATED_AT_MESSAGE"], "\n    ").concat(moment__WEBPACK_IMPORTED_MODULE_0___default()(repo.created_at).format(_constants__WEBPACK_IMPORTED_MODULE_1__["DATE_TIME_FORMAT"]));
  div.appendChild(p);
  return div;
}
